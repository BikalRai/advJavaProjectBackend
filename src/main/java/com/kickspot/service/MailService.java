...
public class MailService {
	...
	public void sendBookingConfirmationEmail(String to, LocalTime startTime, LocalTime endTime, LocalDate date,
			String venueName) {
	...
	public void sendPasswordResetMessage(String to) {
		...
		StringBuilder string = new StringBuilder();
		string
		.append("You have successfully reset your password.\n")
		.append("Please login with your new password");
		
		msg.setTo(to);
		msg.setSubject("Successfull password reset");
		msg.setText(string.toString());
